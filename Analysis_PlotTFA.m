...
F.PathIn               = 'D:\work\data\SSVEP_volmov\EEG\TFA_Gabor_noblinks';
F.Subjects2Use          = [1:20];
...
pl.parameters = {...
    [14.16667 14.16667] {'POz';'O1';'Oz';'O2';'I1';'Iz';'I2'} 'data_induced_bc' [0.6 0.6 0.6] 2 sprintf('vis ind\nSSVEP') ;...
    [14.16667 14.16667] {'POz';'O1';'Oz';'O2';'I1';'Iz';'I2'} 'data_evoked_bc' [0 0 0] 2 sprintf('vis evo\nSSVEP') ;...
    [8 12] {'P9';'P10';'PO7';'PO8';'PO3';'PO4';'POz';'O1';'O2';'Oz';'I1';'I2';'Iz'} 'data_induced_bc' [1 0 0] 1 'vis alpha';...
    [18 30] {'P9';'P10';'PO7';'PO8';'PO3';'PO4';'POz';'O1';'O2';'Oz';'I1';'I2';'Iz'} 'data_induced_bc' [1 0 1] 1 'vis beta';...
    [10 14] {'C3';'CP3'} 'data_induced_bc' [0 0.5 0] 1 'mot alpha';...
    [18 30] {'C3';'CP3'} 'data_induced_bc' [0 0.5 0.9] 1 'mot beta';...
    };
pl.subs2use = F.Subjects2Use;
