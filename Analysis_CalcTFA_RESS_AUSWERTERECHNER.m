...
% F.PathOut               = 'C:\Matlab_user\Christopher\SSVEP_volmov\EEG\TFA_Gabor_RESS_noblinks_CSD'; % with FWHM 1
F.PathOut               = 'C:\Matlab_user\Christopher\SSVEP_volmov\EEG\TFA_Gabor_RESS_noblinks_CSD2'; % with FWHM 0.5
F.PathOut               = 'C:\Matlab_user\Christopher\SSVEP_volmov\EEG\TFA_Gabor_RESS_noblinks_CSD3'; % with FWHM 1 different freqs blinks [-3 3]
F.PathOut               = 'C:\Matlab_user\Christopher\SSVEP_volmov\EEG\TFA_Gabor_RESS_noblinks_CSD4'; % with FWHM 1 different freqs blinks [-3.5 3.5]
F.PathOut               = 'C:\Matlab_user\Christopher\SSVEP_volmov\EEG\TFA_Gabor_RESS_noblinks_CSD5'; % with FWHM 1 different freqs blinks [-3.5 3.5] altered RESS
...
% F.Subjects2Use          = [1 2 3 4 5 7 8 ];
% F.Subjects2Use          = [10 11 12 14 17 18];
F.Subjects2Use          = [24];
F.EEGChans              = 1:64;
F.EMGChans              = [71 72];
F.VEOGChans             = [];
...
F.TFAfreqs              = [4-7*(1/3)-0.5:0.25:45];
