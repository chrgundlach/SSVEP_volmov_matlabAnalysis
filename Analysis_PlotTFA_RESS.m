...
% preallocate data
data4tfce1 = zeros(size(TFA.data_induced_bc));
data4tfce2 = TFA.data_induced_bc;
eloc = TFA.electrodes;
...
if exist([savnam_tfce_tfa(1:regexp(savnam_tfce_tfa,[date '.mat'])-1) p.tfce_olddate],'file') 
    ...
    results_tfce_tfa= ept_TFCE(permute(data4tfce1_tfa,[4 2 1 3]),permute(data4tfce2_tfa,[4 2 1 3]),...
        eloc,'rsample',p.Samp,...
        'type','d','plots',0,...
