...
Gabor.parameters        = {...
    [14.16667 14.16667] {'O1';'Oz';'O2';'I1';'Iz';'I2'} 'induced' [0 0 0] 2 'vis ind SSVEP';...
    [14.16667 14.16667] {'O1';'Oz';'O2';'I1';'Iz';'I2'} 'evoked' [0.4 0.4 0.4] 2 'vis evo SSVEP';...
    [8 12] {'O1';'Oz';'O2';'I1';'Iz';'I2'} 'induced' [1 0 0] 1 'vis alpha';...
    [18 30] {'O1';'Oz';'O2';'I1';'Iz';'I2'} 'induced' [1 0 1] 1 'vis beta';...
    [8 12] {'C3';'CP3';'C5';'CP5'} 'induced' [0 1 0] 1 'mot alpha';...
    [18 30] {'C3';'CP3';'C5';'CP5'} 'induced' [0 1 1] 1 'mot beta';...
    };
